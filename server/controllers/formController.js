...
//     // CURRENT DATE HANDLING - Set to noon UTC for consistency
...
//     // Create a date at noon UTC (this is the same approach used for lastContactedAt)
//     const currentDateNoonUTC = new Date(Date.UTC(year, month, day, 12, 0, 0, 0));
    
//     // Format as "Month Day, Year HH:MM:SS AM/PM Timezone"
//     const currentDateFormatted = currentDateNoonUTC.toLocaleString('en-US', {
//       year: 'numeric',
//       month: 'long',
//       day: 'numeric',
//       hour: 'numeric',
...
//     // CREATED DATE HANDLING - Also set to noon UTC for consistency
//     if (lead.createdAt) {
//       const createdDateObj = new Date(lead.createdAt);
      
//       // Similar to the lastContactedAt approach - create at noon UTC
//       const createdNoonUTC = new Date(
//         Date.UTC(
...
//       // Format the same way as the current date
//       const createdAtFormatted = createdNoonUTC.toLocaleString('en-US', {
//         year: 'numeric',
//         month: 'long',
//         day: 'numeric',
//         hour: 'numeric',
...
//     // Handle lastContactedAt if available (this already uses the noon UTC approach)
//     if (lead.lastContactedAt) {
//       const lastContactedObj = new Date(lead.lastContactedAt);
//       const lastContactedFormatted = lastContactedObj.toLocaleString('en-US', {
//         year: 'numeric',
//         month: 'long',
//         day: 'numeric',
//         hour: 'numeric',
...
exports.generateFormWithLeadData = async (req, res) => {
  try {
    ...
    const now = new Date();
    // Format for displaying in local time
    ...
    if (lead.lastContactedAt) {
      ...
      const lastContactedFormatted = lastContactedDate.toLocaleDateString('en-US', {
        ...
        month: 'long',
        day: 'numeric'
      // }) + ' at ' + lastContactedDate.toLocaleTimeString('en-US', {
      //   hour: 'numeric',
      //   minute: 'numeric',
      //   hour12: true
      });
