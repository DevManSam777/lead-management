...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", async function (e) {
      ...
      // Add extension information to notes if provided
      let notesText = formObject.notes || "";
      
      // Add phone extension to notes if provided
      if (formObject.phoneExtCheck === "on" && formObject.phoneExt) {
        if (notesText) notesText += "\n";
        notesText += `Personal Phone: ${formObject.phone} ext: ${formObject.phoneExt}`;
      }
      
      // Add business phone extension to notes if provided
      if (formObject.businessPhoneExtCheck === "on" && formObject.businessPhoneExt) {
        if (notesText) notesText += "\n";
        notesText += `Business Phone: ${formObject.businessPhone} ext: ${formObject.businessPhoneExt}`;
      }
      
      // Update notes in the form object
      formObject.notes = notesText;
